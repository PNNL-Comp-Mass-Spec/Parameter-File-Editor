Imports ParamFileGenerator.ProgramSettings
Imports System.IO
...
#Region " Public Properties and Functions "
        ...
        Public Shared ReadOnly Property BaseLineParams() As clsParams
            Get
                Return m_Baselineparams
            End Get
        End Property

        Private Shared m_Baselineparams As clsParams
        Public Sub LoadSettings(ByVal iniFilePath As String)
            Dim loadingSuccessful As Boolean
            m_iniFilePath = iniFilePath
            loadingSuccessful = LoadProgramSettings(m_iniFilePath)
            If m_Baselineparams Is Nothing Then
                m_Baselineparams = New clsParams
                m_Baselineparams.LoadTemplate(Me.TemplateFileName)
            End If
...
#End Region
    ...
    Public Class clsCommonModsCollection
        ...
        Default Public Property item(ByVal index As Integer) As clsCommonModDetails
            Get
                Return DirectCast(MyBase.InnerList(index), clsCommonModDetails)
            End Get
