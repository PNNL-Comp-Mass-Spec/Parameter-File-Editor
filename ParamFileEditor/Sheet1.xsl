...
<xsl:for-each select="/dataroot/Sheet1">
<xsl:eval>AppendNodeIndex(me)</xsl:eval>
</xsl:for-each>
<xsl:for-each select="/dataroot/Sheet1">
<xsl:eval>CacheCurrentNode(me)</xsl:eval>
<xsl:if expr="OnFirstNode">
<TR><TH style="width: 1.9166in">
DMS_Name
</TH>
<TH style="width: 0.9375in">
Value_Type
</TH>
<TH style="width: 2.25in">
SQ_Name
</TH>
<TH style="width: 2.4166in">
Internal_Name
</TH>
</TR>
</xsl:if>
<TR><TD>
<xsl:eval no-entities="true">Format(GetValue("DMS_Name", 202),"" ,"")</xsl:eval>
</TD>
<TD>
<xsl:eval no-entities="true">Format(GetValue("Value_Type", 202),"" ,"")</xsl:eval>
</TD>
<TD>
<xsl:eval no-entities="true">Format(GetValue("SQ_Name", 202),"" ,"")</xsl:eval>
</TD>
<TD>
<xsl:eval no-entities="true">Format(GetValue("Internal_Name", 202),"" ,"")</xsl:eval>
</TD>
</TR>
