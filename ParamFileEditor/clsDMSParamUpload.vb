...
#Region "Friend Procedures"
    ...
    Friend Sub AddParamFileMappingEntry(
        ...
        Dim entryType As DMSParamStorage.ParamTypes

        entryType = DirectCast([Enum].Parse(GetType(DMSParamStorage.ParamTypes), entryTypeString), DMSParamStorage.ParamTypes)
...
#Region "Protected & Private Functions "
    ...
    Protected Function SaveParams(ByRef paramSet As Params, blnAutoGenerateDescription As Boolean) As Boolean
        Dim diff As DMSParamStorage.ParamsEntry
        Dim diffCollection As DMSParamStorage
    ...
    Protected Sub tmpSaveMods(ByRef paramSet As Params, ByRef at As IMassTweaker)
        ...
        For Each diff In diffCollection
            If InStr(diff.Type.ToString, "Param") = 0 Then
                If diff.Type <> DMSParamStorage.ParamTypes.IsotopicModification Then
    ...
    Protected Function RunSP_AddUpdateParamEntry(
        paramFileID As Integer,
        entrySeqOrder As Integer,
        entryType As DMSParamStorage.ParamTypes,
        entrySpecifier As String,
