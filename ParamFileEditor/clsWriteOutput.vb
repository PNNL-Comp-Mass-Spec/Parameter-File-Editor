...
Public Class clsWriteOutput
    ...
    Public Function WriteOutputFile( _
        ...
        ByVal FileType As clsParams.ParamFileTypes) As Boolean
    ...
    Private Function DumpToSQStringCollection( _
        ...
        ByVal type As clsParams.ParamFileTypes) As StringCollection
        ...
        With sc
            If type = clsParams.ParamFileTypes.BioWorks_20 Then
                .Add("[Sequest]")
            ElseIf type = clsParams.ParamFileTypes.BioWorks_30 Then
                .Add("[TurboSequest]")
            End If
            ...
            '.Add("create_output_files = " & CType(p.CreateOutputFiles, Integer).ToString)
            .Add("create_output_files = " & ConvertBoolToInteger(p.CreateOutputFiles).ToString)
            .Add("ion_series = " & p.IonSeries.ReturnIonString)
            .Add("diff_search_options = " & p.DynamicMods.ReturnDynModString)
            ...
            If type = clsParams.ParamFileTypes.BioWorks_30 Then
            ...
            .Add("enzyme_number = " & p.SelectedEnzymeDetails.EnzymeID.ToString)
    ...
    Private Sub UploadToDMS(ByVal p As clsParams)
        Dim m_ConnectionString As String = ParamFileEditor.clsMainProcess.mySettings.DMS_ConnectionString
