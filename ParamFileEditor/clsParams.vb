...
Public Class clsParams
    ...
    Const DEF_DB_NAME = "C:\Xcalibur\database\nr.fasta"     'Not really used, just a placeholder


#Region " Private Variables "
    Const DEF_ENZ_SECTION_NAME = "SEQUEST_ENZYME_INFO"
...
#End Region
    ...
    Private Function GetDescription() As String
        ...
        Do While Not s Is Nothing
            If InStr(s, ";DMS_Description = ") Then
...
Public Class clsIonSeries
    Friend m_origIonSeriesString As String
...
Public Class clsEnzymeDetails
    ...
    Private Sub ParseEnzymeString(ByVal enzStr As String)
        ...
        For counter = 1 To Len(enzStr)
            currChar = Mid(enzStr, counter, 1)
            If (currChar = " " And prevChar <> " ") Or (counter = Len(enzStr)) Then
                ReDim Preserve s(placeCounter)
                s(placeCounter) = tmpString
                placeCounter = placeCounter + 1
                tmpString = ""
    ...
    Public Function ReturnEnzymeString() As String
        ...
        s = EnzymeID.ToString & "."
        s = s.PadRight(4, " ") & EnzymeName
        s = s.PadRight(30, " ") & EnzymeCleaveOffset.ToString
        s = s.PadRight(35, " ") & EnzymeCleavePoints
        s = s.PadRight(48, " ")
